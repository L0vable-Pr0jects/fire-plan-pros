...
const Footer = () => {
  ...
  const footerLinks = {
    services: [
      { label: "Fire Safety Plans", href: "#services" },
      { label: "Building Compliance", href: "#services" },
      ...
      <div className="container mx-auto px-4 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-primary-foreground/70 mb-6 max-w-sm leading-relaxed">
              Leading provider of professional fire safety planning and code compliance 
              services. Protecting lives and property through expert solutions.
            </p>
        ...
        <div className="border-t border-primary-foreground/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-primary-foreground/60 text-sm">
            © {currentYear} FirePlanPro. All rights reserved.
          </p>
